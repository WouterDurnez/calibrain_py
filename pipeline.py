...
if __name__ == '__main__':
    ...
    clt_agg_subj.to_csv(
        os.path.join(
            '/Users/jonas/Desktop/CaliBrain_preprocdata', 'clt_subj.csv'
        )
    )
    mrt_agg_subj.to_csv(
        os.path.join(
            '/Users/jonas/Desktop/CaliBrain_preprocdata', 'mrt_subj.csv'
        )
    )
    ...
    mrt_agg_perf.to_csv(
        os.path.join(
            '/Users/jonas/Desktop/CaliBrain_preprocdata', 'mrt_perf.csv'
        )
    )
